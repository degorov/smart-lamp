...
listbox.insert(1, 'AllRandom')
listbox.insert(2, 'LoopNumbers')
listbox.insert(3, 'AllHueLoop')
listbox.insert(4, 'AllHueRotate')
listbox.insert(5, 'Matrix')
listbox.insert(6, 'Sparkles')
listbox.insert(7, 'Snow')
listbox.insert(8, 'Lighters')
listbox.insert(9, 'Fire')
listbox.insert(10, 'Plasma')
